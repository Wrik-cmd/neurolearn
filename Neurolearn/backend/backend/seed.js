...
const courses = [
  { _id: new mongoose.Types.ObjectId('60d5ec496f412a14b01e1111'), title: 'Data Structures & Algorithms', topicsCount: 24, progress: 65, icon: '🧠', difficulty: 'Hard', category: 'Core Subjects' },
  ...
  { _id: new mongoose.Types.ObjectId('60d5ec496f412a14b01e1115'), title: 'Database Design', topicsCount: 16, progress: 45, icon: '🗄️', difficulty: 'Medium', category: 'Core Subjects' },
  ...
  { _id: new mongoose.Types.ObjectId('60d5ec496f412a14b01e1119'), title: 'Computer Networks', topicsCount: 10, progress: 0, icon: '📡', difficulty: 'Medium', category: 'Core Subjects' },
  { _id: new mongoose.Types.ObjectId('60d5ec496f412a14b01e111a'), title: 'Operating Systems', topicsCount: 10, progress: 0, icon: '🖥️', difficulty: 'Hard', category: 'Core Subjects' },
  { _id: new mongoose.Types.ObjectId('60d5ec496f412a14b01e111b'), title: 'Computer Organization', topicsCount: 10, progress: 0, icon: '⚙️', difficulty: 'Hard', category: 'Core Subjects' },

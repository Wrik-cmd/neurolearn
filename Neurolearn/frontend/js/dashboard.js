...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  async function loadChart() {
    ...
    let data = API.mock.chartData;
    try {
      const result = await API.dashboard.getChartData();
      if (result.success) data = result.data.scores;
    } catch {}
  ...
  async function loadActivity() {
    ...
    let activity = API.mock.activity;
    try {
  ...
  async function loadWeakTopics() {
    ...
    let topics = API.mock.weakTopics;
    try {
      const result = await API.dashboard.getWeakTopics();
      if (result.success) topics = result.data;
    } catch {}
  ...
  async function loadCourses() {
    ...
    let courses = API.mock.courses;
    try {
      const result = await API.courses.getAll();
      if (result.success) courses = result.data;
    } catch {}
